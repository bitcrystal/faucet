...
if(true)
{
	if(!isset($_POST['BTCRY'])||$_POST['BTCRY']=="")
	{
		$isvalid=0;
		$_POST['BTCRY'] = " No Address! ";
	} else {
		$isvalid = $btclient->validateaddress($_POST['BTCRY']);
    }
	if ($isvalid['isvalid'] != '1') {

        echo "Invalid Address: {$_POST['BTCRY']}";
        echo "</center></div>";
        include ('templates/sidebar.php');
        include ('templates/footer.php');
        die();
    } else {
    $ltcaddress = $_POST['BTCRY'];
    ...
    SELECT ip FROM dailyltc WHERE ip = '$ip'
            ...
            //echo "printed.";
            // echo "</table>";
            echo "You will get your BTCRY at the end of this round!<br />There are $rows/$entries_needed submitted addresses in this round!<br>";
